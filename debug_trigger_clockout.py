#!/usr/bin/env python3
"""
Debug script untuk test trigger_clockout command
"""
...
async def test_trigger_clockout():
    ...
    print("=== Testing trigger_clockout command ===\n")
    ...
    # Test data
    chat_id = -1001234567890  # Replace with your actual chat ID
    ...
    if config:
        ...
        print("This might be why the command doesn't work!")
    ...
    print("3. Executing trigger_clockout command...")
    try:
